...
export TERRAFORM_PROVIDER_VERSION := 1.21.0-beta.3
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-grafana
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/julienduchesne/terraform-provider-grafana/releases/download/v1.21.0-beta.3
