...
type HTTPParameters struct {
	...
	// +kubebuilder:validation:Optional
	ValidStatusCodes []*int64 `json:"validStatusCodes,omitempty" tf:"valid_status_codes,omitempty"`
}

type MonitoringCheckObservation struct {
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	TenantID *int64 `json:"tenantId,omitempty" tf:"tenant_id,omitempty"`
}

type MonitoringCheckParameters struct {
	...
	// +kubebuilder:validation:Required
	Probes []*int64 `json:"probes" tf:"probes,omitempty"`
...
type PingParameters struct {
	...
	// Payload size.
	// +kubebuilder:validation:Optional
	PayloadSize *int64 `json:"payloadSize,omitempty" tf:"payload_size,omitempty"`
...
type TracerouteParameters struct {
	...
	// +kubebuilder:validation:Optional
	MaxUnknownHops *int64 `json:"maxUnknownHops,omitempty" tf:"max_unknown_hops,omitempty"`
...
// MonitoringCheckSpec defines the desired state of MonitoringCheck
type MonitoringCheckSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MonitoringCheckParameters `json:"forProvider"`
}

// MonitoringCheckStatus defines the observed state of MonitoringCheck.
type MonitoringCheckStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MonitoringCheckObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// MonitoringCheck is the Schema for the MonitoringChecks API
...
type MonitoringCheck struct {
	...
	Spec              MonitoringCheckSpec   `json:"spec"`
	Status            MonitoringCheckStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MonitoringCheckList contains a list of MonitoringChecks
type MonitoringCheckList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MonitoringCheck `json:"items"`
}

// Repository type metadata.
var (
	MonitoringCheck_Kind             = "MonitoringCheck"
	MonitoringCheck_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MonitoringCheck_Kind}.String()
	MonitoringCheck_KindAPIVersion   = MonitoringCheck_Kind + "." + CRDGroupVersion.String()
	MonitoringCheck_GroupVersionKind = CRDGroupVersion.WithKind(MonitoringCheck_Kind)
)

func init() {
	SchemeBuilder.Register(&MonitoringCheck{}, &MonitoringCheckList{})
}
