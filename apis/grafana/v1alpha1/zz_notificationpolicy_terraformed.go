...
func (tr *NotificationPolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *NotificationPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *NotificationPolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *NotificationPolicy) SetParameters(params map[string]interface{}) error {
