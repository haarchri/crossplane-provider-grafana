...
func (mg *AlertNotification) GetTerraformResourceType() string {
	return "grafana_alert_notification"
}
...
func (tr *AlertNotification) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"secure_settings": "spec.forProvider.secureSettingsSecretRef"}
}
...
// LateInitialize this AlertNotification using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AlertNotification) LateInitialize(attrs []byte) (bool, error) {
	params := &AlertNotificationParameters{}
