...
func (tr *MessageTemplate) GetObservation() (map[string]interface{}, error) {
...
func (tr *MessageTemplate) SetObservation(obs map[string]interface{}) error {
...
func (tr *MessageTemplate) GetParameters() (map[string]interface{}, error) {
...
func (tr *MessageTemplate) SetParameters(params map[string]interface{}) error {
