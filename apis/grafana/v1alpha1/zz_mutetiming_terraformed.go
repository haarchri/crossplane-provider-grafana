...
func (tr *MuteTiming) GetObservation() (map[string]interface{}, error) {
...
func (tr *MuteTiming) SetObservation(obs map[string]interface{}) error {
...
func (tr *MuteTiming) GetParameters() (map[string]interface{}, error) {
...
func (tr *MuteTiming) SetParameters(params map[string]interface{}) error {
