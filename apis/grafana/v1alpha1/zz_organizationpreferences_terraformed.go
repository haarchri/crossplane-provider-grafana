...
func (tr *OrganizationPreferences) GetObservation() (map[string]interface{}, error) {
...
func (tr *OrganizationPreferences) SetObservation(obs map[string]interface{}) error {
...
func (tr *OrganizationPreferences) GetParameters() (map[string]interface{}, error) {
...
func (tr *OrganizationPreferences) SetParameters(params map[string]interface{}) error {
