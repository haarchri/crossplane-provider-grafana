...
func (tr *ServiceAccountToken) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServiceAccountToken) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServiceAccountToken) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServiceAccountToken) SetParameters(params map[string]interface{}) error {
