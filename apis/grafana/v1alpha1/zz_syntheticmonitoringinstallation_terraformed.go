...
func (tr *SyntheticMonitoringInstallation) GetID() string {
...
// LateInitialize this SyntheticMonitoringInstallation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SyntheticMonitoringInstallation) LateInitialize(attrs []byte) (bool, error) {
	params := &SyntheticMonitoringInstallationParameters{}
