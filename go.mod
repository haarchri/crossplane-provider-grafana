...
require (
	...
	github.com/grafana/grafana-api-golang-client v0.2.1 // indirect
	github.com/grafana/machine-learning-go-client v0.1.1 // indirect
	github.com/grafana/synthetic-monitoring-agent v0.4.1 // indirect
	github.com/grafana/synthetic-monitoring-api-go-client v0.3.0 // indirect
